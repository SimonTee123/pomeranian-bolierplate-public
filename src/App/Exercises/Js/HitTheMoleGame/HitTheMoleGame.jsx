...
export const HitTheMoleGame = () => {
  ...
  const [moleFieldIds, setMoleFieldId] = useState(getRandomMoleFields(1));
  ...
  const handleClickField = (clickedField, isMolePresent) => {
    ...
    if (isMolePresent) {
      ...
      setPreviousMoleFieldId(moleFieldIds);
      setMoleFieldId(getRandomMoleFields(numMoles));
        ...
        <div>
          ...
          <div className="board">
            {gameFields.map((field) => {
              ...
              const isPreviousMolePresent = previousMoleFieldId.includes(
                field.id
              );
